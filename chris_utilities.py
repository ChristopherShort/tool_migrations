...
def read_abs_notes(folder_path=data_abs_path, fname="310101.xls", sheet_name="Data1"):
    """
...
def read_abs_meta_data(
    folder_path=data_abs_path, fname="310101.xls", sheet_name="Data1"
):
    """
